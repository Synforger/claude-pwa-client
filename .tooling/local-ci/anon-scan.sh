...
PATTERN='(?i)(\b(REDACTED|REDACTED|REDACTED|REDACTED|REDACTED|REDACTED|REDACTED)\b|com\.REDACTED\.|com\.REDACTED\.|\baria\b(?!-)|\bark\b(?!-))'
...
scan_with_perl() {
    local file="$1"
    perl -ne 'BEGIN { $re = qr/(?i)(\b(REDACTED|REDACTED|REDACTED|REDACTED|REDACTED|REDACTED|REDACTED)\b|com\.REDACTED\.|com\.REDACTED\.|\baria\b(?!-)|\bark\b(?!-))/ }
